...
const MOCK_USERS: LeaderboardUser[] = [
  { id: '1', name: 'Joedev', avatar: Avatar, xlm: 12500.5 },
...
const Leaderboard = () => {
  ...
  return (
    <div className='w-full max-w-4xl mx-auto px-4 pb-12'>
      <h1 className='text-3xl font-bold text-[#292D32] text-center mb-10'>
        Leaderboard
      </h1>
      ...
      <div className='flex flex-col md:flex-row items-end justify-center gap-6 mb-12'>
        ...
        {rank2 && (
          <div className='order-2 md:order-1 flex flex-col items-center w-full md:w-1/3'>
            ...
            <p className='text-[#2C4BFD] font-semibold'>
        ...
        {rank1 && (
          <div className='order-1 md:order-2 flex flex-col items-center w-full md:w-1/3 -mt-10 md:mt-0 z-10'>
            ...
            <p className='text-[#2C4BFD] font-bold text-lg'>
        ...
        {restUsers.map((user, index) => (
          ...
          >
            ...
            <div className='text-center md:text-right w-full md:w-auto'>
              <span className='font-bold text-[#2C4BFD]'>
