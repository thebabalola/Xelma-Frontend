      ...
      <nav className='w-full h-20 lg:h-28 flex items-center justify-between px-4 lg:px-14'>
        ...
        <div className='hidden md:flex items-center gap-3.5'>
          ...
          <div
            ...
            className='w-10 h-10 rounded-full cursor-pointer overflow-hidden bg-[#CCCCCC] dark:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-[#2C4BFD]/30'
      ...
      {open && (
        <div className='md:hidden bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 px-4 pb-4 transition-colors'>
          ...
          <div className='mt-4 flex items-center justify-between'>
            ...
            <div
              onClick={() => setProfileOpen(true)}
              className='w-10 h-10 cursor-pointer rounded-full overflow-hidden bg-[#CCCCCC] dark:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-[#2C4BFD]/30'
              aria-label='Open profile settings'
            >
              <img
                src={Avatar}
